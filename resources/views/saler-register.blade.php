    ...
    <main class="mt-0 transition-all duration-200 ease-in-out">
        <section class="min-h-screen">
            <div
                ...
                style="background: url(../assets/img/saller-reg.png)">
                <span
                ...
                <div class="container z-10">
                    <div class="flex flex-wrap justify-center -mx-3">
                        <div
                            ...
                            <h1 class="mt-12 mb-2 text-white">Join the Team!</h1>
                            <p class="text-white">
                                Create your salesman account to start tracking sales and managing inventory with ease.
                            </p>
                        </div>
                    </div>
                </div>
