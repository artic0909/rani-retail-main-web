                            ...
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <h5 class="mb-2 font-bold dark:text-white">₹{{ number_format($todaysSales, 2) }}
                                        </h5>
                            ...
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <p class="mb-0 dark:text-white dark:opacity-60">
                                            <span class="text-sm font-bold leading-normal text-red-600">need</span>
                                            stock refill
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <h5 class="mb-2 font-bold dark:text-white">
                                            ₹{{ number_format($thisMonthSales, 2) }}</h5>
                ...
                <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
                    <div slider class="relative w-full h-full overflow-hidden rounded-2xl">
                        ...
                        <div slide class="absolute w-full h-full transition-all duration-500">
                            <img class="object-cover h-full" src="../assets/img/saller-reg.png" alt="carousel image" />
                            <div
                                            ...
                                            <td
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <h6 class="mb-0 text-sm leading-normal dark:text-white">
                                                        ...
                                                        <a href="{{ route('saler.invoice.view', $sale->id) }}"
                    ...
                    <div class="flex flex-wrap items-center -mx-3 lg:justify-between">
                        <div class="w-full max-w-full px-3 mt-0 mb-6 shrink-0 lg:mb-0 lg:w-1/2 lg:flex-none">
                            <div class="text-sm leading-normal text-center text-slate-500 lg:text-left">
                                ...
                                <a href="#" class="font-semibold text-slate-700 dark:text-white" target="_blank">Rani
                                    Retail</a>
                            </div>
                        </div>
                    </div>
