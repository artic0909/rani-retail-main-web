                ...
                <nav>
                    ...
                    <ol
                        ...
                        <li class="leading-normal text-sm">
                            <a class="opacity-50" href="#">Back</a>
                        </li>
                        <li
                    ...
                    <h6
                        class="mb-2 ml-2 font-bold text-white capitalize dark:text-white">
                        Manage Profile
                    </h6>
                </nav>
                ...
                <div
                    ...
                    <ul
                        ...
                        <li class="flex items-center pl-4 xl:hidden">
                            <a
                                href="javascript:;"
                                class="block p-0 text-white transition-all ease-in-out text-sm"
                                sidenav-trigger>
                        ...
                        <li class="flex items-center px-4">
                            <a
                                href="javascript:;"
                                class="p-0 text-white transition-all ease-in-out text-sm">
                                <i
                        ...
                        <li class="relative flex items-center pr-2">
                            <p
                                class="hidden dark:text-white dark:opacity-60 transform-dropdown-show"></p>
                            <a
                                dropdown-trigger
                                href="javascript:;"
                ...
                <div class="w-full max-w-full px-3 shrink-0 md:w-12/12 md:flex-0">
                    <div
                        ...
                        <div class="flex-auto p-6">
                            ...
                            <!-- Profile Update Form -->
                            <form class="flex flex-wrap -mx-3" action="{{ route('manager.updateProfile') }}" method="POST">
                                @csrf
                                ...
                                <div
                                    ...
                                    <div class="mb-4">
                                        <label
                                            for="mobile"
                                            class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Mobile</label>
                                        <input
                                            type="text"
                                            name="mobile"
                                            value="{{ $user->mobile }}"
                                ...
                                <button
                                    type="submit"
                                    class="mt-4 inline-block px-8 py-2 mb-4 ml-auto font-bold leading-normal text-center text-white align-middle transition-all ease-in bg-blue-500 border-0 rounded-lg shadow-md cursor-pointer text-xs tracking-tight-rem hover:shadow-xs hover:-translate-y-px active:opacity-85">
                                    UPDATE
                                </button>
                            </form>
                            <hr
                            ...
                            <form class="flex flex-wrap -mx-3" method="POST" action="{{ route('manager.updatePassword') }}" enctype="multipart/form-data">
                                @csrf
                                <div
                                    class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                    <div class="mb-4">
