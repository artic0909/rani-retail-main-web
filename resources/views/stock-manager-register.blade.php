  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <ul
            class="flex flex-col pl-0 mx-auto mb-0 list-none lg-max:py-2 lg:flex-row xl:ml-auto"
          >
            <li>
              <a
                class="flex items-center px-4 py-2 mr-2 font-normal text-white transition-all ease-in-out duration-250 lg-max:opacity-0 lg-max:text-slate-700 text-sm lg:px-2 lg:hover:text-white/75"
                aria-current="page"
                href="/"
              >
                <i
                  class="mr-1 text-white lg-max:text-slate-700 fa fa-chart-pie opacity-60"
                ></i>
                Go Back
              </a>
            </li>
            ...
            <li>
              <a
                class="block px-4 py-2 mr-2 font-normal text-white transition-all ease-in-out duration-250 lg-max:opacity-0 lg-max:text-slate-700 text-sm lg:px-2 lg:hover:text-white/75"
                href="/stock-manager-register"
              >
                <i
                  class="mr-1 text-white lg-max:text-slate-700 fas fa-user-circle opacity-60"
                ></i>
                Sign Up
              </a>
            </li>
            <li>
              ...
              >
                <i
                  class="mr-1 text-white lg-max:text-slate-700 fas fa-key opacity-60"
                ></i>
                Sign In
              </a>
            </li>
    ...
    <main class="mt-0 transition-all duration-200 ease-in-out">
      <section class="min-h-screen">
        <div
          ...
          style="background: url(../assets/img/stock-reg.png)"
        >
          <span
          ...
          <div class="container z-10">
            <div class="flex flex-wrap justify-center -mx-3">
              ...
              >
                <h1 class="mt-12 mb-2 text-white">Become a Stock Manager</h1>
                <p class="text-white">
                  Sign up to efficiently manage product entries, update
                  inventory, and keep the store fully stocked and organized.
                </p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              >
                ...
                <div class="flex-auto p-6">
                  <form role="form text-left" method="POST" action="{{ route('store.stock-manager-register') }}">
                    @csrf
                    @method('POST')
